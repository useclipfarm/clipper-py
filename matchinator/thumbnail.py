...
def generate_match_thumb(
    schedule: Schedule, event_name: str, match_name: str, match_key: str = None
) -> Image:
    ...
    d.multiline_text(
        (1920 - 40, 22), match_name, anchor="ra", font=title_fnt, fill=(0, 0, 0)
    )
    ...
    d.text(
        ...
        align="right",
        anchor="rb",
        font=autosize_font(blue1, 450, 50),
        fill=(255, 255, 255),
    )
    d.text(
        (1920 / 2 - 35, 435),
        ...
        align="right",
        anchor="rb",
        font=autosize_font(blue2, 450, 50),
        fill=(255, 255, 255),
    )
    if blue3 is not None:
        d.text(
            ...
            align="right",
            anchor="rb",
            font=autosize_font(blue3, 450, 50),
            fill=(255, 255, 255),
        )
    ...
    d.text(
        ...
        align="left",
        anchor="lb",
        font=autosize_font(red1, 450, 50),
        fill=(255, 255, 255),
    )
    d.text(
        (1920 / 2 + 35, 435),
        ...
        align="left",
        anchor="lb",
        font=autosize_font(red2, 450, 50),
        fill=(255, 255, 255),
    )
    if red3 is not None:
        d.text(
            ...
            align="left",
            anchor="lb",
            font=autosize_font(red3, 450, 50),
            fill=(255, 255, 255),
        )
...
def autosize_font(
    text: str, bbox_width: int, bbox_height: int, min_size: float = 10, step: float = 1
